...
export default function CarsPage(){
  ...
  const activeF=[brand!=="전체",fuel!=="전체",priceR.l!=="전체",yearR.l!=="전체",mileR.l!=="전체"].filter(Boolean).length;
  const resetF=()=>{setBrand("전체");setFuel("전체");setPriceR(PRICES[0]);setYearR(YEARS[0]);setMileR(MILES[0]);};
