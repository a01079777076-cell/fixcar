...
import { Heart, MessageSquare, Phone, MapPin, Shield, ChevronLeft, Share2, AlertTriangle, Check } from "lucide-react";
      ...
      <div style={{minHeight:"100vh",background:"#F0EEE9"}}>
        <div style={{maxWidth:900,margin:"0 auto",padding:"20px 16px 100px"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1.2fr 1fr",gap:24}}>
            {/* 왼쪽: 사진 */}
            <div>
              <div style={{borderRadius:20,overflow:"hidden",background:"#E8E6E1",aspectRatio:"4/3",marginBottom:12}}>
