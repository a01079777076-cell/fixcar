...
import { Clock, Users, AlertTriangle, Shield, ChevronUp } from "lucide-react";
import { useSearchParams } from "next/navigation";
import { Suspense } from "react";

const MOCK_AUCTIONS = [
  { id:1, name:"2019 현대 아반떼 1.6 GDi", year:2019, mileage:62000, fuel:"가솔린", color:"흰색", region:"광주 북구", startPrice:780, currentBid:850, bidCount:7, endsAt:new Date(Date.now()+3600000*5), image:"car", defects:["뒷범퍼 경미한 스크래치"], deduction:30, tags:["1인소유","무사고"] },
  { id:2, name:"2020 기아 K5 2.0 MPI", year:2020, mileage:44000, fuel:"가솔린", color:"검정", region:"광주 서구", startPrice:1580, currentBid:1620, bidCount:3, endsAt:new Date(Date.now()+3600000*12), image:"car", defects:["앞유리 미세 크랙"], deduction:50, tags:["2인소유","하자감가적용"] },
      ...
      <div style={{padding:"22px 24px"}}>
        ...
        {a.defects.length>0 && (
          <div style={{background:"#FFF8EC",border:"1px solid #FFD89A",borderRadius:"10px",padding:"10px 14px",marginBottom:"14px",fontSize:"13px",color:"#7A5500",fontWeight:400}}>
            <strong style={{fontWeight:800}}>⚠️ 하자 내역 (감가 필수 적용):</strong> {a.defects.join(", ")}
          </div>
        )}
      ...
      <div style={{minHeight:"100vh",background:"#F0EEE9"}}>
        ...
        <div style={{maxWidth:"800px",margin:"0 auto",padding:"24px 32px 80px"}}>
          <div style={{background:"#FFF8EC",border:"1px solid #FFD89A",borderRadius:"14px",padding:"16px 20px",marginBottom:"20px",fontSize:"13px",color:"#7A5500",lineHeight:1.8,fontWeight:400}}>
            ...
            • 하자·누락 감가는 필수 반영돼요 (허위 등록 시 즉시 취소)<br/>
            • 입찰가 뒷자리 2자리 숨김: <strong style={{fontWeight:800}}>ex) 19xx만원</strong><br/>
            • 입찰자 수(n명)만 표시 · 순위·이름 절대 비공개<br/>
