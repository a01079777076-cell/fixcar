...
async function main() {
  ...
  console.log("✅ 딜러 유저 생성:", dealerUser1.name, dealerUser2.name);
  ...
  console.log("✅ 딜러 생성:", dealer1.shopName, dealer2.shopName);

  // 기존 차량 삭제
  await prisma.car.deleteMany({});
  console.log("✅ 기존 차량 데이터 초기화");
  ...
  for (const car of cars) {
    ...
    console.log(`  🚗 ${car.brand} ${car.name} 등록`);
  }

  console.log(`\n✅ 차량 ${cars.length}대 삽입 완료!`);
  console.log("🎉 시드 완료! fixcar.kr/api/cars 에서 확인하세요.");
}
